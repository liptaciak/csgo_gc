...
While it's still possible to connect CS:GO to CS2's GC by spoofing the version number, this may break in the future if Valve updates the GC protocol. This project aims to restore most GC-related functionality and provide an easy-to-use basis for projects restoring old versions of CS:GO by extending the base ([csgo_gc](https://github.com/mikkokko/csgo_gc) made by [Mikko Kokko](https://github.com/mikkokko)) with a centralized server.
...
- [Asio](https://github.com/chriskohlhoff/asio) ([Boost Software License](https://github.com/chriskohlhoff/asio/blob/master/LICENSE_1_0.txt))